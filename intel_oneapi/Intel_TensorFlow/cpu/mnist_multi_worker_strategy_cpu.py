...
def set_strategy(args):
    if args.job_name != 'worker':
        raise ValueError("Multi strategy only support worker mode, please check job name")
...
class Train:
    ...
    def train(self, args, strategy):
        ...
        callbacks = [
            ...
            tf.keras.callbacks.experimental.BackupAndRestore(backup_dir=checkpoint_path)
        ]
