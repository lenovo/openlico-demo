...
def main():
    ...
    parser.add_argument('--epochs', '-e', type=int, default=20, metavar='N',
    ...
    if torch.cuda.device_count() > 1:
        ...
        gpu_devices = ','.join([str(id) for id in range(0, torch.cuda.device_count())])
    ...
    elif torch.xpu.device_count() >= 1 and torch.xpu.is_available():
        print("=====================================")
        print("# train model with XPU")
        print('# minibatch-size: {0}'.format(args.batchsize))
        print('# epochs: {0}'.format(args.epochs))
        print("=====================================")
