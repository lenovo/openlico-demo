...
class ExamplesPerSecondHook(tf.estimator.SessionRunHook):
    ...
    def after_run(self, run_context, run_values):  # pylint: disable=unused-argument
        ...
        if self._timer.should_trigger_for_step(global_step):
            ...
            print("---elapsed_secs--and----elapsed_steps-------",
        ...
        if elapsed_time is not None:
            ...
            if global_step > self._warm_steps:
                ...
                tf.compat.v1.logging.info('Batch [%g]:  last %g steps exp/sec = %g, total average exp/sec = %g, Batch_size= %g, elapsed_steps= %g,elapsed_time= %g',
                                          self._total_steps, elapsed_steps, current_examples_per_sec, average_examples_per_sec, self._batch_size, elapsed_steps, elapsed_time)
            else:
