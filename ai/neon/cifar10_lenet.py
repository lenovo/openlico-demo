...
data_dir = os.path.dirname(os.path.realpath(__file__)) + '/../../datasets/cifar10/'
...
bn = True
layers = [Conv((5, 5, 6), init=init_uni, activation=Rectlin(), batch_norm=bn),
          Pooling((2, 2)),
          Conv((5, 5, 16), init=init_uni, activation=Rectlin(), batch_norm=bn),
          Pooling((2, 2)),
          Conv((5, 5, 120), init=init_uni, activation=Rectlin(), batch_norm=bn),
          Affine(nout=84, init=init_uni, activation=Rectlin(), batch_norm=bn),
